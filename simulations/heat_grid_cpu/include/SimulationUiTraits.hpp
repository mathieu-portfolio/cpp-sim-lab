...
struct ConfigUiTraits<heat_grid_cpu::SimulationConfig> {
    static constexpr auto fields = std::make_tuple(
        ...
        TunableField{"advection x", &heat_grid_cpu::SimulationConfig::advectionX, 0.05f, -2.0f, 2.0f},
        TunableField{"advection y", &heat_grid_cpu::SimulationConfig::advectionY, 0.05f, -2.0f, 2.0f},
        TunableField{"ambient", &heat_grid_cpu::SimulationConfig::ambientTemperature, 0.01f, -1.0f, 1.0f},
        TunableField{"brush radius", &heat_grid_cpu::SimulationConfig::brushRadius, 0.25f, 0.5f, 12.0f},
